...
| CSE 308 | Software Engineering Sessional | [Software Engineering Offlines](https://github.com/shadmantabib/CSE-308-Software-Eng) |
...
| Course Code | Course Title | Projects & Resources |
|:-----------:|:-------------|:----------------------|
| CSE 406 | Security Sessional | [Security Project](https://github.com/shadmantabib/CSE-406----secuity) |
| CSE 410 | Computer Graphics Sessional | [Graphics Project](https://github.com/shadmantabib/CSE-410---computer-graphics) |
| CSE 408| Software Development | [CareSync Project](https://github.com/shadmantabib/CareSync---Software-Development) |
...
| Web Development | HTML5, CSS3, JavaScript, Tailwind CSS |
| Databases | MySQL, PostgreSQL, Oracle |
| Tools & Frameworks | Git, Visual Studio Code, LaTeX |
...
| Area | Technologies |
|:----:|:-------------|
| Backend Development | Django, Spring Boot, FastAPI |
| Frontend Development | HTML5, CSS3, Tailwind CSS, JavaScript |
...
For academic collaboration, project engagement, or research opportunities:
